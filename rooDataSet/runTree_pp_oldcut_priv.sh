...
### 2. MC
programMC outRoo_PRMC_pp_oldcut_priv $trigType $accType $mczweighting 0 $initev $nevt $zppPRMC $inputfppPRMC
programMC outRoo_NPMC_pp_oldcut_priv $trigType $accType $mczweighting 0 $initev $nevt $zppNPMC $inputfppNPMC
