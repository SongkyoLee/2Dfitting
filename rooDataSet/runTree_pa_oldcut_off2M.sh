...
### 1. Data
## -- run for Pbp
program outRoo_Data_Pbp_oldcut_v1 $trigType $accType $zweighting 1 $initev $nevt $inputfpbpV1
program outRoo_Data_Pbp_oldcut_v2 $trigType $accType $zweighting 2 $initev $nevt $inputfpbpV2
## -- run for pPb
program outRoo_Data_pPb_oldcut  $trigType $accType $zweighting 0 $initev $nevt $inputfppb

### 2. MC
## -- run for Pbp -MC
programMC outRoo_PRMC_Pbp_oldcut_off2M $trigType $accType $zweighting 0 $initev $nevt $zPbpPRMC $inputfPbpPRMC
programMC outRoo_NPMC_Pbp_oldcut_off2M $trigType $accType $zweighting 0 $initev $nevt $zPbpNPMC $inputfPbpNPMC
## -- run for pPb -MC
programMC outRoo_PRMC_pPb_oldcut_off2M $trigType $accType $zweighting 0 $initev $nevt $zpPbPRMC $inputfpPbPRMC
programMC outRoo_NPMC_pPb_oldcut_off2M $trigType $accType $zweighting 0 $initev $nevt $zpPbNPMC $inputfpPbNPMC
