...
inputfpp=/home/storage/OniaTree/Onia5TeV/ppData/OniaTree_DoubleMu_Run2015E-PromptReco-v1_Run_262157_262328_noCUT_TRKMU.root
...
### 1. Data
program outRoo_Data_pp_oldcut $trigType $accType $datazweighting 0 $initev $nevt $inputfpp
### 2. MC
programMC outRoo_PRMC_pp_oldcut_off $trigType $accType $mczweighting 0 $initev $nevt $zppPRMC $inputfppPRMC
programMC outRoo_NPMC_pp_oldcut_off $trigType $accType $mczweighting 0 $initev $nevt $zppNPMC $inputfppNPMC
