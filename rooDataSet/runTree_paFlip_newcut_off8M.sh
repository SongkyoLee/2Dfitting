...
function program {
  ...
  ./Tree2DatasetsPAFlip =t $2 =a $3 =w $4 =m $5 =n $6 $7 =f $8 $1 >& $1/log &
}
...
function programMC {
  ...
  ./Tree2DatasetsPAMCFlip =t $2 =a $3 =w $4 =m $5 =n $6 $7 =z $8 =f $9 $1 >& $1/log &
}
...
### 2. MC
## -- run for pPb -MC
#programMC outRoo_PRMC_pPbFlip_newcut_off2M $trigType $accType $mczweighting 0 $initev $nevt $zpPbPRMC $inputfpPbPRMC
#programMC outRoo_NPMC_pPbFlip_newcut_off2M $trigType $accType $mczweighting 0 $initev $nevt $zpPbNPMC $inputfpPbNPMC
