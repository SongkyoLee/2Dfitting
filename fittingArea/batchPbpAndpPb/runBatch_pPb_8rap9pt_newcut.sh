...
# Prompt MC
prmc=/afs/cern.ch/work/k/kyolee/private/CMSSW_8_0_0/src/2Dfitting/rooDataSet/outRoo_PRMC_pPb_newcut/outRoo_PRMC_pPb_newcut.root
# Non-prompt MC
npmc=/afs/cern.ch/work/k/kyolee/private/CMSSW_8_0_0/src/2Dfitting/rooDataSet/outRoo_NPMC_pPb_newcut/outRoo_NPMC_pPb_newcut.root
...
cterrfile=$(pwd)/outCtErr/PbpAndpPb/fit_ctauErrorRange_pPb.txt
ctaurange=1.5-3.0
