...
### 2. MC
programMC outRoo_PRMC_pp_newcut_priv $trigType $accType $zweighting 0 $initev $nevt $zppPRMC $inputfppPRMC
programMC outRoo_NPMC_pp_newcut_priv $trigType $accType $zweighting 0 $initev $nevt $zppNPMC $inputfppNPMC
